...
/// The runner is an anamorphism (unfold) driven by the strategy coalgebra.
/// It generates a sequence of retry attempts until the strategy says Finish.
    ...
    let execute
        ...
        let rec loop attempt =
            task {
                ...
                | Continue _ -> return failwith "Pipeline returned Continue; expected Complete."
