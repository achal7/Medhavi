namespace Medhavi.Contracts.Scenario
...
type PlanningVersionId = PlanningVersionId of string

type PlanningContext =
    { ScenarioId: string option
      PlantId: string option
      StockingPointId: string option
      PlanningVersionId: PlanningVersionId option
      HorizonStart: DateTime
      HorizonEnd: DateTime }

    static member Default() : PlanningContext =
        { ScenarioId = None
          PlantId = None
          StockingPointId = None
          PlanningVersionId = None
          HorizonStart = DateTime.Today
          HorizonEnd = DateTime.Today.AddMonths(12) }
