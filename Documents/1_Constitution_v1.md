...
### Law
Given equivalent business inputs, rules, policies, constraints, and configuration, the APS shall be capable of producing reproducible, consistent, and auditable business outcomes.

The APS shall preserve sufficient decision context, provenance, and governing information to reproduce and explain significant business outcomes.

Sources of non-determinism shall be explicit, controlled, and governable.
